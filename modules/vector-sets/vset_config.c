...
int set_bool_config(const char *name, int val, void *privdata, RedisModuleString **err)
{
...
{
    // Numeric parameters
    RM_TRY(RedisModule_RegisterBoolConfig(ctx, "vset-force-single-threaded-execution", 0, REDISMODULE_CONFIG_UNPREFIXED,
