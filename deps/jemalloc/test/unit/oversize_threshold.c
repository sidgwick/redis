...
TEST_BEGIN(test_oversize_threshold) {
    ...
    arena_mallctl(
      "arena.%u.dirty_decay_ms", arena, NULL, NULL, &decay_ms, decay_ms_sz);
    arena_mallctl(
      "arena.%u.muzzy_decay_ms", arena, NULL, NULL, &decay_ms, decay_ms_sz);
    ...
    arena_mallctl("arena.%u.oversize_threshold", arena, NULL, NULL, &threshold,
      threshold_sz);
