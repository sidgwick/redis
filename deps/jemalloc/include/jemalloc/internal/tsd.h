...
#define TSD_DATA_SLOW_INITIALIZER                                              \
    /* tcache_enabled */ TCACHE_ENABLED_ZERO_INITIALIZER,                      \
      /* reentrancy_level */ 0, /* thread_allocated_last_event */ 0,           \
      /* thread_allocated_next_event */ 0,                                     \
      /* thread_deallocated_last_event */ 0,                                   \
      /* thread_deallocated_next_event */ 0, /* tcache_gc_event_wait */ 0,     \
      /* tcache_gc_dalloc_event_wait */ 0, /* prof_sample_event_wait */ 0,     \
      /* prof_sample_last_event */ 0, /* stats_interval_event_wait */ 0,       \
      /* stats_interval_last_event */ 0, /* peak_alloc_event_wait */ 0,        \
      /* peak_dalloc_event_wait */ 0, /* prof_tdata */ NULL,                   \
      ...
      /* sec_shard */ (uint8_t)-1,                                             \
      /* binshards */ TSD_BINSHARDS_ZERO_INITIALIZER, /* tsd_link */ {NULL},   \
      /* in_hook */ false,                                                     \
...
#define TSD_DATA_FAST_INITIALIZER                                              \
    /* thread_allocated */ 0, /* thread_allocated_next_event_fast */ 0,        \
      /* thread_deallocated */ 0, /* thread_deallocated_next_event_fast */ 0,  \
...
#define TSD_INITIALIZER                                                        \
    {TSD_DATA_SLOW_INITIALIZER /* state */ ATOMIC_INIT(                        \
...
#define O(n, t, nt)                                                            \
    JEMALLOC_ALWAYS_INLINE t *tsd_##n##p_get(tsd_t *tsd) {                     \
        ...
        assert(state == tsd_state_nominal || state == tsd_state_nominal_slow   \
