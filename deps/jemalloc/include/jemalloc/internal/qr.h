...
/*
 * Go forwards or backwards in the ring.  Note that (the ring being circular),
 * this always succeeds -- you just keep looping around and around the ring if
 * you chase pointers without end.
 */
...
#define qr_foreach(var, a_qr, a_field)                                         \
    for ((var) = (a_qr); (var) != NULL;                                        \
      (var) = (((var)->a_field.qre_next != (a_qr)) ? (var)->a_field.qre_next   \
                                                   : NULL))
