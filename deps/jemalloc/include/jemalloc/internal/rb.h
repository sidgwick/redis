...
#define rb_proto_impl(a_attr, a_prefix, a_rbt_type, a_type, a_is_summarized)   \
    ...
    a_attr a_type *a_prefix##iter(a_rbt_type *rbtree, a_type *start,           \
      a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg);               \
    a_attr a_type *a_prefix##reverse_iter(a_rbt_type *rbtree, a_type *start,   \
      a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg);               \
    a_attr void a_prefix##destroy(                                             \
      a_rbt_type *rbtree, void (*cb)(a_type *, void *), void *arg);            \
    /* Extended API */                                                         \
    rb_summarized_only_##a_is_summarized(                                      \
      a_attr void a_prefix##update_summaries(                                  \
        a_rbt_type *rbtree, a_type *node);                                     \
      a_attr bool a_prefix##empty_filtered(a_rbt_type *rbtree,                 \
        bool (*filter_node)(void *, a_type *),                                 \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx);           \
      a_attr a_type                                                            \
...
#define rb_summarized_gen(                                                     \
  a_attr, a_prefix, a_rbt_type, a_type, a_field, a_cmp, a_summarize)           \
    rb_gen_impl(                                                               \
      a_attr, a_prefix, a_rbt_type, a_type, a_field, a_cmp, a_summarize, true)

#define rb_gen_impl(a_attr, a_prefix, a_rbt_type, a_type, a_field, a_cmp,                                                                               \
  a_summarize, a_is_summarized)                                                                                                                         \
    typedef struct {                                                                                                                                    \
        a_type *node;                                                                                                                                   \
        int cmp;                                                                                                                                        \
    } a_prefix##path_entry_t;                                                                                                                           \
    static inline void a_prefix##summarize_range(                                                                                                       \
      a_prefix##path_entry_t *rfirst, a_prefix##path_entry_t *rlast) {                                                                                  \
        while ((uintptr_t)rlast >= (uintptr_t)rfirst) {                                                                                                 \
            ...
            (void)node;                                                                                                                                 \
            bool changed =                                                                                                                              \
              a_summarize(node, rbtn_left_get(a_type, a_field, node),                                                                                   \
    ...
    static inline void a_prefix##summarize_swapped_range(                                                                                               \
      a_prefix##path_entry_t *rfirst, a_prefix##path_entry_t *rlast,                                                                                    \
    ...
    a_attr a_type *a_prefix##next(a_rbt_type *rbtree, a_type *node) {                                                                                   \
        ...
        if (rbtn_right_get(a_type, a_field, node) != NULL) {                                                                                            \
            rbtn_first(a_type, a_field, rbtree,                                                                                                         \
              rbtn_right_get(a_type, a_field, node), ret);                                                                                              \
        } else {                                                                                                                                        \
    ...
    a_attr a_type *a_prefix##prev(a_rbt_type *rbtree, a_type *node) {                                                                                   \
        ...
        if (rbtn_left_get(a_type, a_field, node) != NULL) {                                                                                             \
            rbtn_last(a_type, a_field, rbtree,                                                                                                          \
              rbtn_left_get(a_type, a_field, node), ret);                                                                                               \
        } else {                                                                                                                                        \
            a_type *tnode = rbtree->rbt_root;                                                                                                           \
            assert(tnode != NULL);                                                                                                                      \
            ret = NULL;                                                                                                                                 \
    ...
    a_attr void a_prefix##insert(a_rbt_type *rbtree, a_type *node) {                                                                                    \
        ...
        for (pathp--; (uintptr_t)pathp >= (uintptr_t)path; pathp--) {                                                                                   \
            ...
            pathp->node = cnode;                                                                                                                        \
            (void)a_summarize(cnode, rbtn_left_get(a_type, a_field, cnode),                                                                             \
              rbtn_right_get(a_type, a_field, cnode));                                                                                                  \
        }                                                                                                                                               \
    ...
    a_attr a_type *a_prefix##iter_recurse(a_rbt_type *rbtree, a_type *node,                                                                             \
      a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg) {                                                                                       \
        if (node == NULL) {                                                                                                                             \
            return NULL;                                                                                                                                \
        } else {                                                                                                                                        \
    ...
    a_attr a_type *a_prefix##iter_start(a_rbt_type *rbtree, a_type *start,                                                                              \
      ...
      void *arg) {                                                                                                                                      \
        ...
        if (cmp < 0) {                                                                                                                                  \
            ...
            return a_prefix##iter_start(                                                                                                                \
              rbtree, start, rbtn_right_get(a_type, a_field, node), cb, arg);                                                                           \
        } else {                                                                                                                                        \
            a_type *ret;                                                                                                                                \
    ...
    a_attr a_type *a_prefix##iter(a_rbt_type *rbtree, a_type *start,                                                                                    \
      a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg) {                                                                                       \
        ...
        if (start != NULL) {                                                                                                                            \
            ret =                                                                                                                                       \
              a_prefix##iter_start(rbtree, start, rbtree->rbt_root, cb, arg);                                                                           \
        } else {                                                                                                                                        \
            ret = a_prefix##iter_recurse(rbtree, rbtree->rbt_root, cb, arg);                                                                            \
        }                                                                                                                                               \
        return ret;                                                                                                                                     \
    }                                                                                                                                                   \
    a_attr a_type *a_prefix##reverse_iter_recurse(a_rbt_type *rbtree,                                                                                   \
      a_type *node, a_type *(*cb)(a_rbt_type *, a_type *, void *),                                                                                      \
      void *arg) {                                                                                                                                      \
        if (node == NULL) {                                                                                                                             \
            return NULL;                                                                                                                                \
    ...
    a_attr a_type *a_prefix##reverse_iter_start(a_rbt_type *rbtree,                                                                                     \
      a_type *start, a_type *node,                                                                                                                      \
      a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg) {                                                                                       \
        int cmp = a_cmp(start, node);                                                                                                                   \
        if (cmp > 0) {                                                                                                                                  \
            a_type *ret;                                                                                                                                \
    ...
    a_attr void a_prefix##destroy_recurse(a_rbt_type *rbtree, a_type *node,                                                                             \
    ...
    rb_summarized_only_##a_is_summarized(                                                                                                               \
      static inline a_prefix##path_entry_t *a_prefix##wind(a_rbt_type *rbtree,                                                                          \
        a_prefix##path_entry_t path[RB_MAX_DEPTH], a_type *node) {                                                                                      \
          ...
          unreachable();                                                                                                                                \
      } a_attr void a_prefix##update_summaries(a_rbt_type *rbtree,                                                                                      \
        a_type *node) {                                                                                                                                 \
          a_prefix##path_entry_t path[RB_MAX_DEPTH];                                                                                                    \
      ...
      } static inline a_type *a_prefix##first_filtered_from_node(a_type *node,                                                                          \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          ...
          while (true) {                                                                                                                                \
              ...
              if (left != NULL && filter_subtree(filter_ctx, left)) {                                                                                   \
                  ...
                  assert(right != NULL && filter_subtree(filter_ctx, right));                                                                           \
                  node = right;                                                                                                                         \
              }                                                                                                                                         \
          }                                                                                                                                             \
          unreachable();                                                                                                                                \
      } a_attr a_type *a_prefix##first_filtered(a_rbt_type *rbtree,                                                                                     \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *node = rbtree->rbt_root;                                                                                                              \
          ...
          return a_prefix##first_filtered_from_node(                                                                                                    \
            node, filter_node, filter_subtree, filter_ctx);                                                                                             \
      } static inline a_type *a_prefix##last_filtered_from_node(a_type *node,                                                                           \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          assert(node != NULL && filter_subtree(filter_ctx, node));                                                                                     \
          while (true) {                                                                                                                                \
              ...
              if (right != NULL && filter_subtree(filter_ctx, right)) {                                                                                 \
                  ...
                  assert(left != NULL && filter_subtree(filter_ctx, left));                                                                             \
                  node = left;                                                                                                                          \
              }                                                                                                                                         \
          }                                                                                                                                             \
          unreachable();                                                                                                                                \
      } a_attr a_type *a_prefix##last_filtered(a_rbt_type *rbtree,                                                                                      \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *node = rbtree->rbt_root;                                                                                                              \
          if (node == NULL || !filter_subtree(filter_ctx, node)) {                                                                                      \
      ...
      /* multiple times for filtered search, nsearch, psearch, next, and    */ /* prev.                                                              */ \
      static inline a_type *a_prefix##search_with_filter_bounds(                                                                                        \
        a_rbt_type *rbtree, const a_type *key,                                                                                                          \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx,                                                                                     \
        bool include_subtree, bool nextbound, a_type **nextbound_node,                                                                                  \
        a_type **nextbound_subtree, bool prevbound, a_type **prevbound_node,                                                                            \
        a_type **prevbound_subtree) {                                                                                                                   \
          if (nextbound) {                                                                                                                              \
              *nextbound_node = NULL;                                                                                                                   \
              ...
              if (cmp < 0) {                                                                                                                            \
                  if (nextbound) {                                                                                                                      \
                      if (filter_node(filter_ctx, tnode)) {                                                                                             \
                        ...
                        && filter_subtree(filter_ctx, tright)) {                                                                                        \
                          *nextbound_node = NULL;                                                                                                       \
                  ...
                  if (prevbound) {                                                                                                                      \
                      if (filter_node(filter_ctx, tnode)) {                                                                                             \
                        ...
                        && filter_subtree(filter_ctx, tleft)) {                                                                                         \
                          *prevbound_node = NULL;                                                                                                       \
                  ...
                  if (include_subtree) {                                                                                                                \
                      if (prevbound && tleft != NULL                                                                                                    \
                        && filter_subtree(filter_ctx, tleft)) {                                                                                         \
                          *prevbound_node = NULL;                                                                                                       \
                          *prevbound_subtree = tleft;                                                                                                   \
                      }                                                                                                                                 \
                      if (nextbound && tright != NULL                                                                                                   \
                        && filter_subtree(filter_ctx, tright)) {                                                                                        \
                          *nextbound_node = NULL;                                                                                                       \
                          *nextbound_subtree = tright;                                                                                                  \
                      }                                                                                                                                 \
          ...
          return NULL;                                                                                                                                  \
      } a_attr a_type *a_prefix##next_filtered(a_rbt_type *rbtree,                                                                                      \
        a_type *node, bool (*filter_node)(void *, a_type *),                                                                                            \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *nright = rbtn_right_get(a_type, a_field, node);                                                                                       \
          if (nright != NULL && filter_subtree(filter_ctx, nright)) {                                                                                   \
              return a_prefix##first_filtered_from_node(                                                                                                \
                nright, filter_node, filter_subtree, filter_ctx);                                                                                       \
          }                                                                                                                                             \
          a_type *node_candidate;                                                                                                                       \
          a_type *subtree_candidate;                                                                                                                    \
          a_type *search_result =                                                                                                                       \
            a_prefix##search_with_filter_bounds(rbtree, node, filter_node,                                                                              \
              filter_subtree, filter_ctx, /* include_subtree */ false,                                                                                  \
              /* nextbound */ true, &node_candidate, &subtree_candidate,                                                                                \
              /* prevbound */ false, NULL, NULL);                                                                                                       \
          assert(node == search_result || !filter_node(filter_ctx, node));                                                                              \
          if (node_candidate != NULL) {                                                                                                                 \
              return node_candidate;                                                                                                                    \
          }                                                                                                                                             \
          if (subtree_candidate != NULL) {                                                                                                              \
              return a_prefix##first_filtered_from_node(                                                                                                \
                subtree_candidate, filter_node, filter_subtree, filter_ctx);                                                                            \
          }                                                                                                                                             \
          return NULL;                                                                                                                                  \
      } a_attr a_type *a_prefix##prev_filtered(a_rbt_type *rbtree,                                                                                      \
        a_type *node, bool (*filter_node)(void *, a_type *),                                                                                            \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *nleft = rbtn_left_get(a_type, a_field, node);                                                                                         \
          if (nleft != NULL && filter_subtree(filter_ctx, nleft)) {                                                                                     \
              return a_prefix##last_filtered_from_node(                                                                                                 \
                nleft, filter_node, filter_subtree, filter_ctx);                                                                                        \
          }                                                                                                                                             \
          a_type *node_candidate;                                                                                                                       \
          a_type *subtree_candidate;                                                                                                                    \
          a_type *search_result = a_prefix##search_with_filter_bounds(rbtree,                                                                           \
            node, filter_node, filter_subtree, filter_ctx,                                                                                              \
            /* include_subtree */ false, /* nextbound */ false, NULL, NULL,                                                                             \
          ...
          return NULL;                                                                                                                                  \
      } a_attr a_type *a_prefix##search_filtered(a_rbt_type *rbtree,                                                                                    \
        const a_type *key, bool (*filter_node)(void *, a_type *),                                                                                       \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *result = a_prefix##search_with_filter_bounds(rbtree, key,                                                                             \
            ...
            /* prevbound */ false, NULL, NULL);                                                                                                         \
          return result;                                                                                                                                \
      } a_attr a_type *a_prefix##nsearch_filtered(a_rbt_type *rbtree,                                                                                   \
        const a_type *key, bool (*filter_node)(void *, a_type *),                                                                                       \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *node_candidate;                                                                                                                       \
          a_type *subtree_candidate;                                                                                                                    \
          a_type *result = a_prefix##search_with_filter_bounds(rbtree, key,                                                                             \
            filter_node, filter_subtree, filter_ctx,                                                                                                    \
            /* include_subtree */ true, /* nextbound */ true, &node_candidate,                                                                          \
            &subtree_candidate, /* prevbound */ false, NULL, NULL);                                                                                     \
          if (result != NULL) {                                                                                                                         \
              return result;                                                                                                                            \
          }                                                                                                                                             \
          if (node_candidate != NULL) {                                                                                                                 \
          ...
          return NULL;                                                                                                                                  \
      } a_attr a_type *a_prefix##psearch_filtered(a_rbt_type *rbtree,                                                                                   \
        const a_type *key, bool (*filter_node)(void *, a_type *),                                                                                       \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *node_candidate;                                                                                                                       \
          a_type *subtree_candidate;                                                                                                                    \
          a_type *result = a_prefix##search_with_filter_bounds(rbtree, key,                                                                             \
            filter_node, filter_subtree, filter_ctx,                                                                                                    \
            /* include_subtree */ true, /* nextbound */ false, NULL, NULL,                                                                              \
            /* prevbound */ true, &node_candidate, &subtree_candidate);                                                                                 \
          if (result != NULL) {                                                                                                                         \
              return result;                                                                                                                            \
          }                                                                                                                                             \
          ...
          return NULL;                                                                                                                                  \
      } a_attr a_type *a_prefix##iter_recurse_filtered(a_rbt_type *rbtree,                                                                              \
        a_type *node, a_type *(*cb)(a_rbt_type *, a_type *, void *),                                                                                    \
        ...
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          ...
          a_type *left = rbtn_left_get(a_type, a_field, node);                                                                                          \
          a_type *right = rbtn_right_get(a_type, a_field, node);                                                                                        \
          ret = a_prefix##iter_recurse_filtered(                                                                                                        \
            rbtree, left, cb, arg, filter_node, filter_subtree, filter_ctx);                                                                            \
          if (ret != NULL) {                                                                                                                            \
              return ret;                                                                                                                               \
          }                                                                                                                                             \
          ...
          return a_prefix##iter_recurse_filtered(                                                                                                       \
            rbtree, right, cb, arg, filter_node, filter_subtree, filter_ctx);                                                                           \
      } a_attr a_type *a_prefix##iter_start_filtered(a_rbt_type *rbtree,                                                                                \
        a_type *start, a_type *node,                                                                                                                    \
        a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg,                                                                                       \
        bool (*filter_node)(void *, a_type *),                                                                                                          \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          ...
          if (cmp < 0) {                                                                                                                                \
              ...
              return a_prefix##iter_start_filtered(rbtree, start, right, cb,                                                                            \
                arg, filter_node, filter_subtree, filter_ctx);                                                                                          \
          } else {                                                                                                                                      \
              if (filter_node(filter_ctx, node)) {                                                                                                      \
                  ret = cb(rbtree, node, arg);                                                                                                          \
      ...
      } a_attr a_type *a_prefix##iter_filtered(a_rbt_type *rbtree,                                                                                      \
        a_type *start, a_type *(*cb)(a_rbt_type *, a_type *, void *),                                                                                   \
        void *arg, bool (*filter_node)(void *, a_type *),                                                                                               \
        bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                   \
          a_type *ret;                                                                                                                                  \
          if (start != NULL) {                                                                                                                          \
              ret =                                                                                                                                     \
                a_prefix##iter_start_filtered(rbtree, start, rbtree->rbt_root,                                                                          \
        ...
        *a_prefix##reverse_iter_recurse_filtered(a_rbt_type *rbtree,                                                                                    \
          ...
          bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                                 \
            ...
            return a_prefix##reverse_iter_recurse_filtered(                                                                                             \
              rbtree, left, cb, arg, filter_node, filter_subtree, filter_ctx);                                                                          \
        } a_attr a_type                                                                                                                                 \
          *a_prefix##reverse_iter_start_filtered(a_rbt_type *rbtree,                                                                                    \
            a_type *start, a_type *node,                                                                                                                \
            a_type *(*cb)(a_rbt_type *, a_type *, void *), void *arg,                                                                                   \
            bool (*filter_node)(void *, a_type *),                                                                                                      \
            bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                               \
              ...
              if (cmp > 0) {                                                                                                                            \
                  ...
                  return a_prefix##reverse_iter_recurse_filtered(rbtree, left,                                                                          \
                    cb, arg, filter_node, filter_subtree, filter_ctx);                                                                                  \
              } else if (cmp < 0) {                                                                                                                     \
          ...
          } a_attr a_type *a_prefix##reverse_iter_filtered(a_rbt_type *rbtree,                                                                          \
            a_type *start, a_type *(*cb)(a_rbt_type *, a_type *, void *),                                                                               \
            void *arg, bool (*filter_node)(void *, a_type *),                                                                                           \
            bool (*filter_subtree)(void *, a_type *), void *filter_ctx) {                                                                               \
              a_type *ret;                                                                                                                              \
