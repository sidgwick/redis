...
struct pai_s {
    ...
    edata_t *(*alloc)(tsdn_t *tsdn, pai_t *self, size_t size, size_t alignment,
    ...
    size_t (*alloc_batch)(tsdn_t *tsdn, pai_t *self, size_t size,
      ...
      bool *deferred_work_generated);
    bool (*expand)(tsdn_t *tsdn, pai_t *self, edata_t *edata, size_t old_size,
      size_t new_size, bool zero, bool *deferred_work_generated);
    bool (*shrink)(tsdn_t *tsdn, pai_t *self, edata_t *edata, size_t old_size,
    ...
    void (*dalloc_batch)(tsdn_t *tsdn, pai_t *self, edata_list_active_t *list,
      bool *deferred_work_generated);
...
pai_alloc_batch(tsdn_t *tsdn, pai_t *self, size_t size, size_t nallocs,
  edata_list_active_t *results, bool *deferred_work_generated) {
    return self->alloc_batch(
      tsdn, self, size, nallocs, results, deferred_work_generated);
}
...
pai_expand(tsdn_t *tsdn, pai_t *self, edata_t *edata, size_t old_size,
  size_t new_size, bool zero, bool *deferred_work_generated) {
    return self->expand(
      tsdn, self, edata, old_size, new_size, zero, deferred_work_generated);
}
