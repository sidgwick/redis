...
#define hdr_atomic_compare_exchange_64(field, expected, desired)                                                       \
    __atomic_compare_exchange_n(field, expected, desired, false, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST)
