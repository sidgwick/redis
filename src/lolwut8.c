...
void lolwut8Command(client *c)
{
    ...
    Verse verses[] = {
        ...
        {" The blinding / globe / of fire ", " l accecante   /  globo  /  di fuoco  ", "1/4", "2/3", "1"},
        {" It expands / rapidly ", " si espande   /  rapidamente  ", "1/2", "3/4", "1"},
        {" Thirty times / brighter / than the sun ", " trenta volte  / piu luminoso  / del sole ", "2/3", "2/4", "1"},
        {" When it reaches / the stratosphere ", " quando  raggiunge / la stratosfera  ", "3/4", "1/2", "1"},
        {" The summit / of the cloud ", " la  sommita  /  della nuvola ", "1/3", "2/3", "1"},
        {" Assumes / the well-known shape / of a mushroom ", " assume   / la ben nota forma  / di fungo ", "2/4", "3/4",
         "1"},

        // Group 2: Elevator mystery verses.
        {" The head / pressed / upon the shoulder ", " la testa / premuta  / sulla spalla  ", "1/4", "2/4", "2"},
        {" The hair / between the lips ", " i  capelli   /  tra le labbra ", "1/4", "2/4", "2"},
        {" They lay / motionless / without speaking ", " giacquero  /   immobili / senza parlare ", "2/3", "2/3", "2"},
        {" Till he moved / his fingers / slowly ", " finche non mosse  /  le dita  / lentamente    ", "3/4", "1/3",
         "2"},
        {" Trying / to grasp ", " cercando / di afferrare  ", "3/4", "1/2", "2"},

        // Group 3: Tao Te Ching verses.
        {" While the multitude / of things / comes into being ", " mentre la moltitudine  /  delle cose  /   accade   ",
         "1/2", "1/2", "3"},
        {" I envisage / their return ", " io contemplo  /  il loro ritorno    ", "2/3", "3/4", "3"},
        {" Although / things / flourish ", " malgrado / che le cose  /  fioriscano    ", "1/2", "2/3", "3"},
        {" They all return / to / their roots ", " esse tornano  / tutte    / alla loro radice   ", "2/3", "1/4", "3"}};
    ...
    combined = sdscat(combined, "\nIn 1961, Nanni Balestrini created one of the first computer-generated poems, "
                                "TAPE MARK I, using an IBM 7090 mainframe. Each execution combined verses from "
                                "three literary sources following algorithmic rules based on metrical compatibility "
                                "and group constraints. This LOLWUT command reproduces Balestrini's original "
                                "algorithm, generating new stanzas through the same computational poetry process "
                                "described in Almanacco Letterario Bompiani, 1962.\n\n"
